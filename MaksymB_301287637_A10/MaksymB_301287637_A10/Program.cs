...
namespace MaksymB_301287637_A10
{
    internal class Program
    {
        ...
        static List<Person> persons = new List<Person>()
            {
              ...
              new Person(){ Age = 62, Asset = 18.4, Country = "Ukraine", IsFemale=false, Name="Leonid Mikhelson"},
              new Person(){ Age = 51, Asset = 17.5, Country = "Ukraine", IsFemale=false, Name="Alexey Mordashov"},
        ...
        static void Task()
        {
            ...
            Console.WriteLine("=============================================");
            Console.WriteLine("First: assets 50B+");
            var p1 = from p in persons
                 where p.Asset > 50
                 select p;
            ...
            Console.WriteLine("=============================================");
            Console.WriteLine("Second: non-US citizen");
            p1 = from p in persons
                 where p.Country != "US"
                 select p;
            foreach (var item in p1)
            {
            ...
            Console.WriteLine("=============================================");
            Console.WriteLine("Third: females from India");
            var pName = from p in persons
            ...
            Console.WriteLine("=============================================");
            Console.WriteLine("Forth: first name is short");
            p1 = from p in persons
            ...
            Console.WriteLine("=============================================");
            Console.WriteLine("Fifth: sort by assets");
            var p2 = from p in persons
                 orderby p.Asset
            ...
            Console.WriteLine("=============================================");
            Console.WriteLine("Sixth: group by country");
            var p3 = from p in persons
            ...
            Console.WriteLine("=============================================");
            Console.WriteLine("Seventh: sort country grouping");
            var p4 = from p in persons
                     orderby p.Country
                     group p by p.Country;
            ...
            Console.WriteLine("=============================================");
            Console.WriteLine("8: Fruits from Mexico");
            var mexicanFruits = from f in fruits
                 where f.Origin == "Mexico"
                 select f;
            foreach (var item in mexicanFruits)
            {
                Console.WriteLine(item);
            }
            Console.WriteLine("=============================================");
            Console.WriteLine("8: Student with name Xavier");
            var studentVictor = from s in students
                                where s.First == "Xavier"
                                select s;
            foreach (var item in studentVictor)
            {
                Console.WriteLine(item);
            }
            Console.WriteLine("=============================================");
            Console.WriteLine("8: Fruits Sorted by price");
